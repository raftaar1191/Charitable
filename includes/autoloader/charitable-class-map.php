...
"Charitable_Singleton"  =>  "abstracts/abstract-class-charitable-singleton.php", 
...
"Charitable_Map"  =>  "charitable-class-map.php", 
"Api"  =>  "class-api.php", 
...
"Charitable_Upgrade"  =>  "class-charitable-upgrade.php", 
...
"Deprecated_Charitable_Templates"  =>  "deprecated/deprecated-class-charitable-templates.php", 
