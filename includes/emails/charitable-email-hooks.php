 ...
 * @see     Charitable_Email_Pledge_Receipt::send_with_donation_id()
 * @see     Charitable_Email_Pledge_Notification::send_with_donation_id()
 */
...
add_action( 'charitable_after_save_donation', array( 'Charitable_Email_Pledge_Receipt', 'send_with_donation_id' ) );
add_action( 'charitable_after_save_donation', array( 'Charitable_Email_Pledge_Notification', 'send_with_donation_id' ) );
