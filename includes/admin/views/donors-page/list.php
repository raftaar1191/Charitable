<?php
/**
 * Display the Donor list table.
 *
 * @author  Studio 164a
 * @package Charitable/Admin View/Donors Page
 * @since   1.7.0
 * @version 1.7.0
 */
...
?>
	<div class="wrap">
		...
		<form id="charitable-donors-search-filter" method="get" action="<?php echo admin_url( 'admin.php?page=donors' ); ?>">
